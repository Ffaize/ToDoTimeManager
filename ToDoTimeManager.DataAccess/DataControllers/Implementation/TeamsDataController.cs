...
public class TeamsDataController : ITeamsDataController
{
    ...
    public async Task<List<TeamEntity>> GetAllTeams()
    {
        try
        {
            return await _dbAccessService.GetAllRecords<TeamEntity>("sp_Teams_GetAll");
        }
        catch (Exception e)
        {
    ...
    public async Task<TeamEntity?> GetTeamById(Guid teamId)
    {
        try
        {
            return await _dbAccessService.GetRecordById<TeamEntity>("sp_Teams_GetById", teamId);
        }
        catch (Exception e)
        {
            _logger.LogError(e, e.Message);
    ...
    public async Task<List<TeamEntity>> GetTeamsByUserId(Guid userId)
    {
        try
        {
            return await _dbAccessService.GetAllByParameter<TeamEntity>("sp_Teams_GetByUserId", "UserId", userId);
        }
        catch (Exception e)
        {
            _logger.LogError(e, e.Message);
    ...
    public async Task<bool> CreateTeam(TeamEntity newTeam)
    {
        try
        {
            return await _dbAccessService.AddRecord("sp_Teams_Create", newTeam) >= 1;
        }
        catch (Exception e)
        {
            _logger.LogError(e, e.Message);
    ...
    public async Task<bool> UpdateTeam(TeamEntity updatedTeam)
    {
        try
        {
            return await _dbAccessService.UpdateRecord("sp_Teams_Update", updatedTeam) >= 1;
        }
        catch (Exception e)
        {
            _logger.LogError(e, e.Message);
    ...
    public async Task<bool> DeleteTeam(Guid teamId)
    {
        try
        {
            return await _dbAccessService.DeleteRecordById("sp_Teams_DeleteById", teamId) >= 1;
        }
        catch (Exception e)
        {
            _logger.LogError(e, e.Message);
