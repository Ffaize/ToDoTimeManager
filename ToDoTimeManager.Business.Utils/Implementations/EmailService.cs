...
public class EmailService : IEmailService
{
    ...
    public async Task SendPasswordResetCodeAsync(string toEmail, string code)
    {
        ...
        message.From.Add(new MailboxAddress(senderName, senderEmail));
        message.To.Add(MailboxAddress.Parse(toEmail));
        message.Subject = "Reset your password — ToDoTimeManager";
                ...
                <head>
                    ...
                    <style>
                        @media only screen and (max-width: 680px) {
                            ...
                            .panel { padding: 32px 28px !important; }
                        }
                        @media only screen and (max-width: 540px) {
                            ...
                            .otp-cell { width: 42px !important; height: 50px !important; font-size: 20px !important; }
                            .otp-dash { width: 16px !important; font-size: 15px !important; }
                            .otp-gap { width: 5px !important; }
                        }
                        @media only screen and (max-width: 380px) {
                            .panel { padding: 24px 16px !important; }
                            .title { font-size: 18px !important; }
                            .otp-cell { width: 36px !important; height: 44px !important; font-size: 17px !important; }
                            .otp-dash { width: 12px !important; font-size: 13px !important; }
                            .otp-gap { width: 3px !important; }
                        }
                    </style>
                </head>
                                ...
                                <table class="outer-table" width="640" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td class="panel" valign="top" bgcolor="#161a20"
                                            ...
                                            <p style="margin:0 0 14px;font-family:'JetBrains Mono','Courier New',monospace;font-size:10px;text-transform:uppercase;letter-spacing:0.18em;color:#ff6a2b;">
                                                &#8212;&nbsp;Password Reset</p>
                                            ...
                                            <p style="margin:0 0 24px;font-size:13px;color:#8a909c;line-height:1.6;">Enter the code
                                                below in the app to set a new password. Valid for <span
                                                    style="color:#f4f5f7;background-color:rgba(255,106,43,0.10);padding:1px 7px;border-radius:5px;border:1px solid rgba(255,106,43,0.2);font-family:'JetBrains Mono','Courier New',monospace;font-size:11px;">5&nbsp;min</span>
                                                and can only be used once.</p>
                                            ...
                                            <p style="margin:0;font-size:11px;color:#5a6271;line-height:1.5;">If you did not request
                                                a password reset, you can safely ignore this email. Your password will not change.</p>
